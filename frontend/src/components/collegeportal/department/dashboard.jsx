      ...
      <div className="body flex flex-col">
        ...
        <div className="grid grid-cols-5 gap-1 mt-32 ">
          ...
          bg-white drop-shadow-2xl cursor-pointer flex flex-col justify-between">
              ...
              <div className="value font-semibold text-4xl text-text-blue pt-1.5">20</div>
          </div>
          ...
          bg-white drop-shadow-2xl cursor-pointer flex flex-col justify-between">
              ...
              <div className="value font-semibold text-4xl text-text-blue pt-1.5">310</div>
          </div>
        ...
        <div className="col-span-1 total-college-registered-card card font-inter m-2 p-5
          bg-white drop-shadow-2xl cursor-pointer flex flex-col justify-between">
              ...
              <div className="value font-semibold text-4xl text-text-blue pt-1.5">33</div>
          </div>
