...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`${BASE_URL}/examinerPortal/loginExaminer`, values);
  ...
  return (
    <div className='m-10 mr-20 content flex flex-col'>
      <div className="header flex justify-between items-center">
        <span className={`font-inter font-semibold text-4xl mr-96`}>LOGIN TO CAP <span className="bg-yellow-300">EXAMINER PORTAL</span> </span>
        <NavLink to="/">
      ...
      <div className='body register-college-form flex flex-col'>
        ...
        <div className="mt-8  hover:cursor-pointer">
          <NavLink to="../examinerregister" >
            <span className='text-text-blue pt-1.5'>Click here to Register <ArrowOutwardIcon sx={{ fontSize: 18 }} /> </span>
          </NavLink>
        </div>
      </div>
